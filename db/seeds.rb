...
seb = User.create!(name: "Seb",email: "seb@gmail.com", password: "123456", avatar: "seb.jpg")
...
aatik = User.create!(name: "Aatik",email: "aatik@gmail.com", password: "123456", avatar: "aatik.jpg")
adria = User.create!(name: "Adria",email: "adria@gmail.com", password: "123456", avatar: "adria.jpg")
carla = User.create!(name: "Carla",email: "carla@gmail.com", password: "123456", avatar: "carla.jpg")
lina = User.create!(name: "Lina",email: "lina@gmail.com", password: "123456", avatar: "lina.jpg")
eduardo = User.create!(name: "Eduardo",email: "eduardo@gmail.com", password: "123456", avatar: "eduardo.jpg")
erik = User.create!(name: "Erik",email: "erik@gmail.com", password: "123456", avatar: "erik.jpg")
mila = User.create!(name: "Mila",email: "mila@gmail.com", password: "123456", avatar: "mila.jpg")
florian = User.create!(name: "Florian",email: "florian@gmail.com", password: "123456", avatar: "florian.jpg")
gabrielle = User.create!(name: "Gabrielle",email: "gabrielle@gmail.com", password: "123456", avatar: "gabrielle.jpg")
gabby = User.create!(name: "Gabby",email: "gabby@gmail.com", password: "123456", avatar: "gabby.jpg")
manon = User.create!(name: "Manon",email: "manon@gmail.com", password: "123456", avatar: "manon.jpg")
ines = User.create!(name: "Inès",email: "ines@gmail.com", password: "123456", avatar: "ines.jpg")
gabriel = User.create!(name: "Gabriel",email: "gabriel@gmail.com", password: "123456", avatar: "gabriel.jpg")
sacha = User.create!(name: "Sacha",email: "sacha@gmail.com", password: "123456", avatar: "sacha.jpg")
mia = User.create!(name: "Mia",email: "mia@gmail.com", password: "123456", avatar: "mia.jpg")
esteban = User.create!(name: "Esteban",email: "esteban@gmail.com", password: "123456", avatar: "esteban.jpg")
nina = User.create!(name: "Nina",email: "nina@gmail.com", password: "123456", avatar: "nina.jpg")
inaya = User.create!(name: "Inaya",email: "inaya@gmail.com", password: "123456", avatar: "inaya.jpg")
margaux = User.create!(name: "Margaux",email: "margaux@gmail.com", password: "123456", avatar: "margaux.jpg")
louna = User.create!(name: "Louna",email: "louna@gmail.com", password: "123456", avatar: "louna.jpg")
lilou = User.create!(name: "Lilou",email: "lilou@gmail.com", password: "123456", avatar: "lilou.jpg")
timeo = User.create!(name: "Timéo",email: "timeo@gmail.com", password: "123456", avatar: "timeo.jpg")
victoria = User.create!(name: "Victoria",email: "victoria@gmail.com", password: "123456", avatar: "victoria.jpg")
iris = User.create!(name: "Iris",email: "iris@gmail.com", password: "123456", avatar: "iris.jpg")
anais = User.create!(name: "Anais",email: "anais@gmail.com", password: "123456", avatar: "anais.jpg")
ayden = User.create!(name: "ayden",email: "ayden@gmail.com", password: "123456", avatar: "ayden.jpg")
mathilde = User.create!(name: "Mathilde",email: "mathilde@gmail.com", password: "123456", avatar: "mathilde.jpg")
hugo = User.create!(name: "Hugo",email: "hugo@gmail.com", password: "123456", avatar: "hugo.jpg")
noa = User.create!(name: "Noa",email: "noa@gmail.com", password: "123456", avatar: "noa.jpg")
